<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="帖子标题" prop="tiezibiaoti">
					<el-input v-model="ruleForm.tiezibiaoti" placeholder="帖子标题" clearable  :readonly="ro.tiezibiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="帖子标题" prop="tiezibiaoti">
					<el-input v-model="ruleForm.tiezibiaoti" placeholder="帖子标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-if="type!='info' && !ro.fengmiantupian" label="封面图片" prop="fengmiantupian">
					<file-upload
						tip="点击上传封面图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-else-if="ruleForm.fengmiantupian" label="封面图片" prop="fengmiantupian">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="帖子分类" prop="tiezifenlei">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-if="type!='info'&& !ro.shipinzhanshi" label="视频展示" prop="shipinzhanshi">
					<file-upload
						tip="点击上传视频展示"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="type!='info'"  label="帖子内容" prop="tiezineirong">
					<editor 
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.tiezineirong" label="帖子内容" prop="tiezineirong">
                    <span :style='{"fontSize":"inherit","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.tiezineirong"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tiezineirong = this.ruleForm.tiezineirong.replace(reg,'../../../springbootil464u7m/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.shipinzhanshi!=null) {
		this.ruleForm.shipinzhanshi = this.ruleForm.shipinzhanshi.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `youxiutiezi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.youxiutieziCrossAddOrUpdateFlag = false;
											this.parent.search();
    ...
    shipinzhanshiUploadChange(fileUrls) {
	    this.ruleForm.shipinzhanshi = fileUrls;
    },
  }
};
</script>
