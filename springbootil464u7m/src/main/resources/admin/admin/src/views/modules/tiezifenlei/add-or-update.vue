<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="帖子分类" prop="tiezifenlei">
					<el-input v-model="ruleForm.tiezifenlei" placeholder="帖子分类" clearable  :readonly="ro.tiezifenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="帖子分类" prop="tiezifenlei">
