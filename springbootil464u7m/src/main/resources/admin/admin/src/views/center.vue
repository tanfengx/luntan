<template>
  <div :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='huiyuan'"  label="会员账号" prop="huiyuanzhanghao">
          <el-input v-model="ruleForm.huiyuanzhanghao" readonly              placeholder="会员账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='huiyuan'"  label="会员姓名" prop="huiyuanxingming">
          <el-input v-model="ruleForm.huiyuanxingming"               placeholder="会员姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='huiyuan'"  label="昵称" prop="nicheng">
          <el-input v-model="ruleForm.nicheng"               placeholder="昵称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='huiyuan'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='huiyuan'"  label="性别" prop="xingbie">
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='huiyuan'"  label="个性签名" prop="gexingqianming">
          <el-input v-model="ruleForm.gexingqianming"               placeholder="个性签名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='huiyuan'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='huiyuan'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='huiyuan'"  label="密保问题" prop="pquestion">
          <el-input v-model="ruleForm.pquestion"               placeholder="密保问题" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='huiyuan'"  label="密保答案" prop="panswer">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
        ...
        if(this.ruleForm.huiyuanzhanghao && ((this.ruleForm.huiyuanzhanghao).toString().length<3) && `huiyuan` == this.flag){
            this.$message.error(`会员账号长度不能小于3`);
            return
        }

        if(this.ruleForm.huiyuanzhanghao && ((this.ruleForm.huiyuanzhanghao).toString().length>13) && `huiyuan` == this.flag){
      ...
      if((!this.ruleForm.mima)&& 'huiyuan'==this.flag){
        ...
        if(this.ruleForm.mima && ((this.ruleForm.mima).toString().length<3) && `huiyuan` == this.flag){
            this.$message.error(`密码长度不能小于3`);
            return
        }

        if(this.ruleForm.mima && ((this.ruleForm.mima).toString().length>13) && `huiyuan` == this.flag){
      ...
      if( 'huiyuan' ==this.flag && this.ruleForm.status&&(!isIntNumer(this.ruleForm.status))){
       this.$message.error(`状态应输入整数`);
        return
      }


      if( 'huiyuan' ==this.flag && this.ruleForm.passwordwrongnum&&(!isIntNumer(this.ruleForm.passwordwrongnum))){
