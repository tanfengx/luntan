<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0 0 4px","boxShadow":"none","margin":"20px auto 0","borderColor":"#eee","background":"none","borderWidth":"0 0 1px","width":"calc(100% - 60px)","fontSize":"16px","borderStyle":"solid","height":"auto"}'>
