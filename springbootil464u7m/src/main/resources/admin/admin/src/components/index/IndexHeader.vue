<template>
	<div class="navbar">
		...
		<!-- 系统通知-1 -->
		<el-button class="notice" @click="dialogVisible = true" :style='{"border":"0","cursor":"pointer","padding":"0 12px","outline":"none","color":"#fff","borderRadius":"4px","background":"rgba(255, 255, 255, .3)","width":"auto","fontSize":"inherit","height":"40px","order":"4"}' type="success">
		  <span class="icon iconfont icon-xiaoxi-zhihui" :style='{"margin":"0 2px","fontSize":"inherit","color":"#fff","height":"40px"}'></span>
		  系统提示
		</el-button>
		<el-dialog title="系统提示" :append-to-body="true" :visible.sync="dialogVisible" width="30%">
