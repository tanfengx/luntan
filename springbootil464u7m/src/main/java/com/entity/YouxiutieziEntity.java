...
public class YouxiutieziEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YouxiutieziEntity() {
		
	}
	
	public YouxiutieziEntity(T t) {
		try {
	 ...
	 * 设置：视频展示
	 */
	public void setShipinzhanshi(String shipinzhanshi) {
		this.shipinzhanshi = shipinzhanshi;
	}
	/**
	 * 获取：视频展示
	 */
	public String getShipinzhanshi() {
		return shipinzhanshi;
	}
	/**
	 * 设置：帖子内容
	 */
