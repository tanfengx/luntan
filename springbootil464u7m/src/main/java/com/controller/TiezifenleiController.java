...
public class TiezifenleiController {
    ...
    public R save(@RequestBody TiezifenleiEntity tiezifenlei, HttpServletRequest request){
        if(tiezifenleiService.selectCount(new EntityWrapper<TiezifenleiEntity>().eq("tiezifenlei", tiezifenlei.getTiezifenlei()))>0) {
            return R.error("帖子分类已存在");
        }
    ...
    public R update(@RequestBody TiezifenleiEntity tiezifenlei, HttpServletRequest request){
        //ValidatorUtils.validateEntity(tiezifenlei);
        if(tiezifenleiService.selectCount(new EntityWrapper<TiezifenleiEntity>().ne("id", tiezifenlei.getId()).eq("tiezifenlei", tiezifenlei.getTiezifenlei()))>0) {
            return R.error("帖子分类已存在");
        }
